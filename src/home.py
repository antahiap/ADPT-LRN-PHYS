...
if "window_view" not in st.session_state:
    st.session_state.window_view = [0, 1]
if "left_button_disabled" not in st.session_state:
    st.session_state.left_button_disabled = True
if "right_button_disabled" not in st.session_state:
    st.session_state.right_button_disabled = True
